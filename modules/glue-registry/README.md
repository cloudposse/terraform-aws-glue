...
| Name | Description |
|------|-------------|
| <a name="output_arn"></a> [arn](#output\_arn) | Glue registry ARN |
| <a name="output_id"></a> [id](#output\_id) | Glue registry ID |
| <a name="output_name"></a> [name](#output\_name) | Glue registry name |
